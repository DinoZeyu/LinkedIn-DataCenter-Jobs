...
Instruction = (
        ...
        "role: the specific position or job title\n"
        "domain: the general domain or field (e.g., Data Engineering, Cybersecurity)\n"
        "core_skills: a list of key technical or functional skills\n"
        "soft_skills: a list of interpersonal or general competencies\n"
        "summary: a concise one-sentence summary of the job’s focus\n\n"
        "Example format:\n"
        "{\n"
        "  \"role\": \"Data Engineer\",\n"
        "  \"domain\": \"Technology\",\n"
        ...
        "  \"summary\": \"Responsible for building and maintaining data pipelines.\"\n"
        "}\n\n"
